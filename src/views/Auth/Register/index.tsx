      ...
      <div className={classes.root2}>
        ...
        <div className={classes.container2}>
          <div className={classes.registerFormContainer}>
            <div>
              <Typography className={clsx(classes.fontColor1, classes.h4)}>Create Wallet Account</Typography>
          ...
          <div className={classes.footer1}>© 2022 Wallet. All rights reserved</div>
        </div>
        {alert === undefined ? (
          ''
        ) : (
